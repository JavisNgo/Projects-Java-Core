...
public class AccountChecker {
    ...
    public boolean check(Account acc) {
        List<String> lines= MyTool.readLinesFormFile(accFile);
    ...
    public static void main(String[] args) {
        ...
        Account acc1 = new Account("E001", "12345678", "BOSS");
        boolean valid= aChk.check(acc1);
        System.out.println("Needs OK: OK? "+valid);
        acc1 = new Account("E003", "123456789", "AQC-1");
        valid = aChk.check(acc1);
